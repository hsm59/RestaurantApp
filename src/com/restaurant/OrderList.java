...
public class OrderList extends Activity {
	 ...
	 public void onCreate(Bundle savedInstanceState) {
	       ...
	       //Initialize list view to display data in list
	      ...
	      adapter=new ArrayAdapter<String>(OrderList.this,
	        ...
	        {
	        	Toast.makeText(this, "Yet No order is placed, Please go to the menu section and add an order.", Toast.LENGTH_LONG).show();
	        ...
	        list.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0,
					...
					//order remove functionality on alert box button
	      ...
	      placedorder.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try{
					...
					HttpPost postMethod=new HttpPost("http://localhost:8080/RestaurantServlet/OrderPosted");  
