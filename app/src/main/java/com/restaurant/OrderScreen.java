...
public class OrderScreen extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
     ...
     // initialise form widget
       ...
       // show_order =(Button)findViewById(R.id.Show_Order_btn);
        ...
        if(s.equals("Iced Caffe Latte")||s.equals("Iced Caramel Macchiato")){	
	...
	public void onClick(View v) {
		...
		//on button click place order
			...
			if((temps.equals("Iced Caramel Macchiato")||temps.equals("Iced Caffe Latte")) && !(devide_quanity.getText().toString().equals("")))  {	
				Log.e("temp","iside");
			...
			finish();
				...
				Toast.makeText(OrderScreen.this,"Enter a Valid Quantity!", Toast.LENGTH_LONG).show();
				Place_Order.setClickable(true);
			}
	}
